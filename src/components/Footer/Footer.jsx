    ...
    <footer className={style.footer}>
      <Container className={style.container}>
        <div className={style.footer__content}>
          <img className={style.footer__logo} src={logo} alt="Логотип YourMeal" />
          ...
          <address className={style.footer__address}>
            ...
            <div className={style.footer__contact}>
              <h2 className={classNames(style.footer__title, style.footer__title_sn)}>Мы в соцсетях</h2>

              <ul className={style.footer__list}>
                <li className={style.footer__item}>
                  <a href="#" className={style.footer__sn} aria-label="группа в вк">
                    <svg
                      width="36"
                      height="36"
                      viewBox="0 0 36 36"
                ...
                <li className={style.footer__item}>
                  <a href="#" className={style.footer__sn} aria-label="канал в telegram">
                    <svg
                      width="36"
                      height="36"
                      viewBox="0 0 36 36"
          ...
          <div className={style.footer__development}>
            ...
            <p>
              Developer: <a href="mailto:maksim.leskin@methed.ru">Mark Soikin</a>
            </p>
          </div>
        </div>
      </Container>
